 ...
 *
 * Not a tab bar: it navigates nothing, appears on no other screen, and carries
 * no icons. It exists so that neither half needs a scroll view of its own —
 * the pours used to be a horizontal pager nested inside the vertical scroll,
 * and the two fought each other and the sliders.
 */
