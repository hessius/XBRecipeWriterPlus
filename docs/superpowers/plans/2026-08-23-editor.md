...
describe("the stages deck", () => {
    ...
    it("counts the stages on the switch", async () => {
        ...
        // `DeckSwitch` speaks the count: `Stages, ${stageCount}`.
        expect(screen.getByLabelText("Stages, 3")).toHaveTextContent("3");
    });
...
function StagesDeck({recipe, balance, accent, isTea, openStage, setOpenStage,
    ...
    // told how wide the screen is. `$4` of padding either side of the screen
    // and `$3` inside the card is 64 points in total.
