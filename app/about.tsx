...
const TICKER_LINES = [
    ...
    "THE MACHINE CHECKS YOUR ARITHMETIC BEFORE IT BREWS",
    "POUR VOLUMES MUST SUM TO DOSE TIMES RATIO",
    "RATIOS ARE WHOLE NUMBERS OR THEY ARE NOTHING",
    "GRIND SIZE FORTY-ONE MEANS THE GRINDER STAYS OFF",
    "DOSE AND RPM LIVE ONLY IN THE FIRST POUR",
    "PAUSES ARE STORED BACKWARDS AND NOBODY KNOWS WHY",
    "TEA IS CAPPED AT NINETY MILLILITRES A CUP",
    "OVERFLOW PROTECTION OFF IS CALLED OMNI IN THE BYTES",
    "CRC EIGHT MAXIM DOW GUARDS THE LAST BYTE",
    "THIRTEEN POINT FIVE SIX MEGAHERTZ OF CONVERSATION",
    "ISO FIFTEEN SIX NINETY-THREE HOLD IT STILL",
    "FOUR BYTES TO A BLOCK AND EIGHT BLOCKS TO SKIP",
    "NO ACCOUNT NO CLOUD NO TELEMETRY NO THANKS",
    "GREETINGS TO EVERYONE STILL RESOLDERING THINGS"
];
