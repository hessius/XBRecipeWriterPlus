 ...
 *
 * The register is a 90s crack intro, and the point of a crack intro scroller
 * was never to inform anybody. It was greetz, boasts and non-sequiturs at three
 * in the morning. So these lean nonsense — tangentially about coffee, cards and
 * this app, and committed to none of it. A ticker that recites specifications
 * is a changelog with extra steps; nobody waits eight seconds for a changelog.
 *
 * Rules of thumb for adding one: it should be untrue, or true in a way that
 * helps nobody. It should fit on a phone without the reader hurrying. And it
 * should never explain a feature.
 */
const TICKER_LINES = [
    "GREETZ TO EVERYONE STILL WEIGHING BEANS BY EYE",
    "NO BEANS WERE HARMED — SEVERAL WERE SEVERELY GROUND",
    "THIS RECIPE HAS BEEN BLESSED BY A SMALL ANTENNA",
    "THIRTEEN POINT FIVE SIX MEGAHERTZ OF PURE GOSSIP",
    "THE CARD KNOWS WHAT YOU DID LAST BREW",
    "WATER IS JUST COFFEE THAT GAVE UP",
    "SHOUTS TO THE ONE POUR THAT HOLDS ALL THE SECRETS",
    "RATIOS ARE WHOLE NUMBERS BECAUSE HALF A RATIO IS A LIE",
    "GRIND SIZE FORTY-ONE MEANS THE GRINDER IS ON STRIKE",
    "SOMEWHERE A CHECKSUM IS DISAPPOINTED IN YOU",
    "DECAF DETECTED — DEPLOYING JUDGEMENT",
    "PLEASE DO NOT LICK THE NFC CARD",
    "ALL YOUR BREW ARE BELONG TO US",
    "THE PAUSE IS STORED BACKWARDS AND WE HAVE MADE PEACE WITH IT",
    "ROASTED IN A HURRY — DOCUMENTED AT LEISURE",
    "IF YOU ARE READING THIS THE COFFEE HAS GONE COLD",
    "BLOOM RESPONSIBLY",
    "TWO PLUSES BETTER THAN ONE PLUS — MATHEMATICS CONFIRMS",
    "EIGHT BLOCKS SKIPPED — NOBODY SAW ANYTHING",
    "OUR LAWYER IS A SINGLE PARAGRAPH FURTHER DOWN THIS PAGE",
    "TEA MODE EXISTS AND WE ARE NOT TAKING QUESTIONS",
    "THIS SCROLLER TOOK LONGER THAN THE CARD FORMAT",
    "HAND ROLLED BYTES — NO ARTIFICIAL FLAVOURS",
    "PRESS THE MARK ABOVE UNTIL SOMETHING GIVES",
    "CAFFEINE IS A CIRCLE AND SO IS THIS LIST",
    "GREETZ TO THE MACHINE THAT REFUSED SIX HUNDRED RECIPES",
    "OVERFLOW PROTECTION OFF — LIVE A LITTLE",
    "NO CLOUD NO ACCOUNT NO NEWSLETTER NO THANKS"
];
